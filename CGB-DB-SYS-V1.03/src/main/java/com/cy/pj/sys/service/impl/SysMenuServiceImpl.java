...
public class SysMenuServiceImpl implements SysMenuService{
	...
	public int saveObject(SysMenu entity) {
		//1.参数校验(自己实现)
		if(entity==null)throw new IllegalArgumentException("保存对象参数异常");
		if(entity.getName().isEmpty())throw new IllegalArgumentException("菜单名不正确");
		//2.将数据对象持久化到数据库
		Integer rows=null;
		try {
